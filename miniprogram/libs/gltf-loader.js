 ...
 */
  ...
  THREE.GLTFLoader = (function () {
    ...
    GLTFParser.prototype.loadTexture = function (textureIndex) {
      ...
      // 微信小程序无 window，URL 挂在 globalThis（基础库 2.19+ 提供 URL）
      var URL =
        (typeof window !== "undefined" && (window.URL || window.webkitURL)) ||
      ...
      if (source.bufferView !== undefined) {
        ...
        sourceURI = parser.getDependency('bufferView', source.bufferView).then(function (bufferView) {
          ...
          var mime = source.mimeType || "image/png";

          if (typeof Blob !== "undefined" && URL && typeof URL.createObjectURL === "function") {

            isObjectURL = true;
            var blob = new Blob([bufferView], { type: mime });
            return URL.createObjectURL(blob);

          }

          // 微信小程序主线程无 Blob 时，用 data URL（wx.arrayBufferToBase64）
          if (typeof wx !== "undefined" && typeof wx.arrayBufferToBase64 === "function") {

            isObjectURL = false;
            return "data:" + mime + ";base64," + wx.arrayBufferToBase64(bufferView);

          }

          throw new Error("THREE.GLTFLoader: embedded texture needs Blob or wx.arrayBufferToBase64");
